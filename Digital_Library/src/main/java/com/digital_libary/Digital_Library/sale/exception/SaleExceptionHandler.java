package com.digital_libary.Digital_Library.sale.exception;
...
public class SaleExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleSaleException(Exception ex, WebRequest webRequest) {
    ...
    public final ResponseEntity<Object> handleSaleInvalidException(Exception ex, WebRequest webRequest) {
        ErrorDetails errorDetails = new ErrorDetails(
                LocalDateTime.now(),
